...
//   // tttapi.register({credentials: {}}, function(){})
//   tttapi.register = function (credentials, callback) {
//     this.ajax({
//       method: 'POST',
//       url: ttt + "/users",
...
//   tttapi.login = function (credentials, callback) {
//     this.ajax({
//       method: 'POST',
//       url: ttt + '/login',
//       contentType: 'application/json; charset=utf-8',
